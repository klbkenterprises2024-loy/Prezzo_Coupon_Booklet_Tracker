...
import { getPasscodes } from "../lib/db";
...
export default function Login({
  ...
  return (
    <div className="min-h-screen bg-[#FAF6F0] text-stone-800 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      {/* Decorative background pizza slices */}
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md z-10 px-4">
        ...
        >
          <p className="text-center text-sm text-stone-600 mb-6 leading-relaxed font-sans">
            Welcome to the Prezzo Coupon Portal. Enter your authorized staff passcode to access booklets, track redemptions, and log sales.
          </p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-3 border border-stone-200 rounded-xl text-stone-900 text-lg font-mono tracking-widest text-center bg-stone-50 focus:outline-none focus:ring-1 focus:ring-[#991B1B] focus:border-[#991B1B] transition-all"
                />
              </div>
            </div>
